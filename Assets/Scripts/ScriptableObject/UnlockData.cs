...
{
    private const string UNLOCK_PLAYERPREF_KEY = "UNLOCK_PLAYERPREF_KEYFF:";
    public string unlockableName;

    public int price;
    public int RemainingPrice => price - CollectedPrice; // Edited to show unlockarea always restarts  
